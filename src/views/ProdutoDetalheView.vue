  ...
  <div class="min-h-screen bg-background flex flex-col">
    <div class="flex-1">
      ...
      <div class="max-w-7xl mx-auto" v-if="produto">
        <div class="card">
          <div class="p-6 md:p-8 bg-white rounded-md border-2">
            ...
            <div class="flex flex-col md:flex-row gap-8">
              ...
              <div class="md:w-2/3">
                ...
                <div class="flex gap-4">
                  <router-link to="/pedidos" class="p-1 flex items-center gap-2 bg-[#5eccc1] rounded-md text-white font-bold inline-block cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export default {
  ...
  async mounted() {
    ...
    try {
      const resposta = await axios.get(`https://localhost:7136/api/produto/codigoDeBarras/${codigo}`)
